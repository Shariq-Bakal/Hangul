...
const Header = () => {
        ...
        return ( <
            ...
            <
            Link to = "/"
            className = "navbar-brand" > Hangul < /Link> <
            ...
            /li> {
                authStatus ? < button type = "btn"
                className = "btn btn-secondary m-1"
                onClick = { logoutHandler } > Logout < /button>: < li className = "nav-item" >
                    <
                    NavLink to = "/login"
                ...
                aria - current = "page" > Cart < /NavLink> <
                    ...
                    <
                    NavLink to = "/wishlist"
                className = "nav-link" > Wishlist < /NavLink> <
                    /li> <
                    li className = "nav-item" >
                    <
                    NavLink to = "/account"
